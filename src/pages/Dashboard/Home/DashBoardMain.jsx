  ...
  return (
    <div className="p-6 min-h-screen ">
      ...
      <div ref={containerRef}>
        ...
        <p className="text-gray-600 mb-6">Manage events, create news, and track donations.</p>

        {/* Dashboard Sections */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Event Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105 duration-300">
            <h2 className="text-xl font-semibold mb-2 text-blue-600">Create Event</h2>
          ...
          {/* News Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105 duration-300">
            <h2 className="text-xl font-semibold mb-2 text-green-600">Create News</h2>
          ...
          {/* Donation Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105 duration-300">
            <h2 className="text-xl font-semibold mb-2 text-purple-600">Donation List</h2>
