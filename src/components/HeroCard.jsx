...
export const HeroCard = ({ image, title, description, buttonText }) => {
  return (
    <div className="relative bg-green-900 text-white p-6 rounded-3xl 2xl:w-64 w-52 2xl:h-96 h-[19rem] flex flex-col justify-between overflow-hidden ">
      ...
      <div className="space-y-2 m-auto">
        ...
        <p className="2xl:text-sm text-xs font-medium">{description}</p>
      </div>
      {/* Donate Button */}
